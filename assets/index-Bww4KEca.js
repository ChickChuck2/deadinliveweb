        ...
        <section id="home" class="landing-section">
          <div class="landing-content">
            <h1 class="landing-title">
              <span class="fade-in-up">Reconstrua a</span><br>
              <span class="highlight-text fade-in-up delay-1">Realidade Fragmentada.</span>
            </h1>
